# Template simple con bootstrap

Forkeado de [acá](https://github.com/BlackrockDigital/startbootstrap-creative).  
Web: [Start Bootstrap - Creative](https://startbootstrap.com/template-overviews/creative/).  
